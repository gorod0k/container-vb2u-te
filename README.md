...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-vb2u-te.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-vb2u-te.containers.anotherwebservice.com/
...
```
git clone git@github.com:gorod0k/container-vb2u-te.git
cd container-vb2u-te
```
...
```
docker attach container-vb2u-te
```
